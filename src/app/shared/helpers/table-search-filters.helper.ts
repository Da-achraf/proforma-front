...
export class PlantSearchFilterStrategy implements ISearchFilterStrategy<PlantModel> {
...
export class DepartmentSearchFilterStrategy implements ISearchFilterStrategy<DepartmentModel> {
    
    filter(searchValue: string, departements: DepartmentModel[]): DepartmentModel[] {
...
export class ShipPointSearchFilterStrategy implements ISearchFilterStrategy<ShipPointModel> {
...
export const searchFilterStrategyFactory = (tableName: TableNameEnum): StrategyMap[TableNameEnum] => {
    switch (tableName) {
